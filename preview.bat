@echo off
REM Double-click to build the production bundle and serve it locally.
REM Useful for testing the real build output before deploying.
...
echo.
echo Serving the build. Your browser will open automatically.
